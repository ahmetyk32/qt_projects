...
#include <memory>
#include "../../../../../server/client/mytcpserver.h"
...
QT_MOC_LITERAL(4, 49, 12), // "dataRecieved"
...
QT_MOC_LITERAL(8, 110, 15) // "clientDataReady"
    ...
    "clientDisconnect\0dataRecieved\0message\0"
...
void MyTcpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->dataRecieved((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTcpServer::dataRecieved)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void MyTcpServer::dataRecieved(QString _t1)
{
